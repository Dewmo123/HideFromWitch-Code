...
namespace ServerCore
{
    ...
    public abstract class Session
    {
        ...
        private Queue<ArraySegment<byte>> _sendQueue = new Queue<ArraySegment<byte>>();//아직 보내기 전 패킷
        private List<ArraySegment<byte>> _pendingList = new List<ArraySegment<byte>>();//지금 보내는 작업 중인 패킷들
