...
class PacketManager
{
	...
	public void Register()
	{
		...
		_onRecv.Add((ushort)PacketID.C_Shoot, MakePacket<C_Shoot>);
		_handler.Add((ushort)PacketID.C_Shoot, PacketHandler.C_ShootHandler);
		_onRecv.Add((ushort)PacketID.C_Attack, MakePacket<C_Attack>);
		_handler.Add((ushort)PacketID.C_Attack, PacketHandler.C_AttackHandler);
		_onRecv.Add((ushort)PacketID.C_ResourceLoadComplete, MakePacket<C_ResourceLoadComplete>);
		_handler.Add((ushort)PacketID.C_ResourceLoadComplete, PacketHandler.C_ResourceLoadCompleteHandler);
		_onRecv.Add((ushort)PacketID.C_UseSkill, MakePacket<C_UseSkill>);
		_handler.Add((ushort)PacketID.C_UseSkill, PacketHandler.C_UseSkillHandler);
		_onRecv.Add((ushort)PacketID.C_Scanned, MakePacket<C_Scanned>);
		_handler.Add((ushort)PacketID.C_Scanned, PacketHandler.C_ScannedHandler);
		_onRecv.Add((ushort)PacketID.C_MoveLock, MakePacket<C_MoveLock>);
		_handler.Add((ushort)PacketID.C_MoveLock, PacketHandler.C_MoveLockHandler);
		_onRecv.Add((ushort)PacketID.C_Fall, MakePacket<C_Fall>);
		_handler.Add((ushort)PacketID.C_Fall, PacketHandler.C_FallHandler);
